...
- 证书模板:server / client / codesign / email / subca / 国密签名 / 国密加密,各自定义 KU、EKU、basicConstraints、有效期。
...
- **两种 PFX 加密**:现代(AES-256 + PBKDF2 + SHA256)/ 兼容(3DES + SHA1-MAC,老 Windows、老 Java、部分 UKey 工具只认这个)。合成后自动回读校验。
...
**¥128 / 每台机器,一次买断,永久使用**,授权绑定本机。三步开通,全在软件里:

1. 打开软件,激活界面**扫码支付 ¥128**;
2. 把界面上的**「本机指纹」**发给客服(微信/官网);
3. 客服核对后回你一个**授权文件**,在激活界面「从文件载入」即开通。

> 授权绑定本机(以系统机器标识派生指纹)。换电脑或重装系统后,把新指纹发来即可**免费重签**。购买与客服入口见软件激活界面与[官网](https://lifeisshortplaymore.com)。

<div align="center"><img src="assets/wwca-activate.png" width="560" alt="软件内激活 · 扫码支付 + 载入授权文件"></div>
...
**Q:授权换电脑还能用吗?**<br>
授权绑定本机。换机或重装系统后本机指纹会变,把新指纹发给客服即可免费重签一份。
